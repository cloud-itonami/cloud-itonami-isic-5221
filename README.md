...
```bash
kbb -M:dev:run     # walk one clean authorize + reconcile lifecycle, plus HARD-hold cases, through the actor
kbb -M:dev:test    # governor contract · phase invariants · store contract · registry conformance · facts coverage
