# Operator Quickstart — Community Land Transport Support Operations

Shortest path from clone to a verified local dry-run for **ISIC 5221** (`cloud-itonami-isic-5221`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-5221.git
cd cloud-itonami-isic-5221
```
...
- Blueprint governor key: `land-transport-support-governor`
- Likely source path: `src/**/land-transport-support-governor.cljc`
